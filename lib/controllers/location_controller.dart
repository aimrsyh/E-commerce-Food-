...
import 'package:ecomm_food/data/api/api_checker.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  */
  ...
  /*
  save the google map suggestion for thr address
  */
  List<Prediction> _predictionList = [];

  /* 
 Future<void> getCurrentLocation(bol fromAddress,
  ...
  void updatePosition(CameraPosition position, bool fromAddress) async {
    if (_updateAddressData) {
      ...
      try {
        ...
        /*
        if button value is false in the service area
        */
  ...
  Future<ResponseModel> getZone(String lat, String lng, bool markerLoad) async {
    ...
    */
    print("zone response code is " +
        response.statusCode
            .toString()); //200,404(problem with route),505(problem with server),403(permission problem)
    update();
